...
<header class="border-b">
	<nav class="mx-auto max-w-screen-md px-5 py-8 text-center">
		...
		<nav class="mt-3 flex justify-center gap-4 text-sm">
			...
			<p>|</p>
			<a href="/#tentang" class="hover:text-lime-700">Tentang</a>
		</nav>
	</nav>
</header>
{@render children()}
<footer
	class="mx-auto flex max-w-screen-md flex-col items-center justify-center gap-6 border-t px-5 py-8 md:flex-row md:justify-between md:gap-0"
>
	<p class="text-center md:text-left">
		© 2024 <a href="https://www.mhafidk.com" class="hover:text-lime-700"
			><span class="font-medium text-lime-600">Muhammad Hafid K</span></a
		>. All rights reserved.
	</p>
